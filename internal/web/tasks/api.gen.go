...
type Task struct {
	// Id Primary key (UUID or string ID from DB)
...
type PatchTaskJSONRequestBody = TaskUpdateRequest
...
type PatchTask404Response struct {
}

func (response PatchTask404Response) VisitPatchTaskResponse(w http.ResponseWriter) error {
	w.WriteHeader(404)
	return nil
}
